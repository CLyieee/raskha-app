    ...
    <div className="flex flex-col rounded-lg">
      ...
      <div className="flex justify-between w-full">
        ...
        <div className="flex flex-col w-1/2">
          <h3 className="text-center font-bold text-xl border-b border-gray-400">Mahui</h3>
          <img 
            src={IMG.mahui} 
        ...
        <div className="flex flex-col w-1/2">
          <h3 className="text-center font-bold text-xl border-b border-gray-400">Kidu</h3>
          <img 
            src={IMG.kidu} 
      ...
      <div className="flex justify-between items-center w-full mt-4 p-2 border-t border-gray-400">
